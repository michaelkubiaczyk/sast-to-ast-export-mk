...
const (
	...
	projectNameMapArg       = "project-names"
...
func init() {
	...
	rootCmd.Flags().StringP(projectNameMapArg, "", "", "JSON file containing a struct of { \"ProjectID1\":\"TargetName1\", \"ProjectID2\":\"TargetName2\", ...}  to force specific project names in Cx1")
